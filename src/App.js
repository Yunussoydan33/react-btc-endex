...
class App extends Component {
  ...
  render() {
    if (this.state.historicalData) {
      return (
        <div className="app">
          <Header title="Bitcoin Fiyat Endeksi" />
          <p style={{fontFamily: 'Bungee'}}>YAPIMCI : Yunussoydan33</p> {/* Yeni satır eklenmiştir */}
          <div className="select-container">
            <span style={{fontSize: 18, fontFamily: 'Bungee'}}> Para Biriminizi Seçin: </span>
            ...
            </select>
            {
              this.state.currency !== 'PHP' && (<div>
                <a href="#" className="link" onClick={() => this.setCurrency('PHP')} style={{color: "black", fontSize: 16, fontFamily: 'Bungee'}}> [SIFIRLAMAK İÇİN BURAYA TIKLAYIN] </a>
              </div>)
            }
          </div>
